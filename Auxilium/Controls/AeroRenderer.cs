...
namespace Auxilium.Controls
{
    ...
    public class AeroRenderer : ToolStripSystemRenderer
    {
        ...
        public AeroRenderer(ToolbarTheme theme, bool drawBackground)
        {
            Theme = theme;
        ...
        private Padding GetThemeMargins(IDeviceContext dc, MarginTypes marginType)
        {
            ...
            try
            {
                ...
                if (0 == Native.GetThemeMargins(renderer.Handle, hDC, renderer.Part, renderer.State, (int)marginType, IntPtr.Zero, out margins))
